...
<c:set var="contextPath" value="${pageContext.request.contextPath}" />
	...
	<header class="header">
				...
				<div id="userbox" class="userbox">
					<a href="#" data-toggle="dropdown">
						<figure class="profile-picture">
							<img src="${contextPath}/resources/assets/images/avtar.png" alt="Logged User" class="img-circle"/>
						</figure>
						<div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@okler.com">
							<span class="name">Er. Ramesh Panda</span>
					...
					<div class="dropdown-menu">
						<ul class="list-unstyled">
							...
							<li>
								<a role="menuitem" tabindex="-1" onclick="logout()"><i class="fa fa-power-off"></i> Logout</a>
							</li>
						</ul>
					</div>
				</div>
		...
		<form id="logoutFrm" method="POST" action="${contextPath}/logout">
