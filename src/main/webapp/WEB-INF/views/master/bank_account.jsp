										...
										<div class="col-md-12">
											<div class="col-md-3">
												<div class="form-group">
													<label class="col-md-12" for="inputDefault">Role:</label>
													<div class="col-md-12">
														<select data-plugin-selectTwo class="form-control populate" id="role" onchange="selectrole(this)">
															<option value="0"> -- Select Role -- </option>
															<option value="admin">ADMIN</option>
															<option value="dsso">DISTRICT USER</option>
											...
											<div class="col-md-3">
												<div class="form-group">
													<label class="col-md-12">Districts :</label>
													<div class="col-md-12">
